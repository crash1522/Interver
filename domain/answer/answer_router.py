...
@router.post("/create/{question_id}", response_model=answer_schema.AnswerReponse)
def answer_create(question_id: int,
    ...
    print("필요 질문 개수 ",  q_cnt_dict[record_id].required_question_num )
    print("현재 질문 개수 ", q_cnt_dict[record_id].cur_question_num)
    print()
    if q_cnt_dict[record_id].required_question_num == q_cnt_dict[record_id].cur_question_num:
        answer_response.last_question_flag = True
        del agent_dict[record_id]   
